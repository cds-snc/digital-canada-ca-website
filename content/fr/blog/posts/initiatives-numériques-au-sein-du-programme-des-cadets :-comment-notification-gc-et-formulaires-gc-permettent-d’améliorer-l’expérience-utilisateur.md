...
<p class="wp-block-paragraph" style="font-size:12px">Légende: Capture d’écran d’un gabarit de courriel bilingue relatif au programme des Cadets dans Notification GC. Le gabarit contient des champs réservés que la feuille de calcul remplit en fonction de l’identité du contact (rang, prénom et nom). Un lien hypertexte dirigé les destinataires vers le sondage Formulaires GC.&rsquo;</p>



<p class="wp-block-paragraph">Nous utilisons déjà fréquemment Notification&nbsp;GC dans le cadre de la prestation de bon nombre de nos services et nous envisageons d’élargir le public cible auprès duquel nous l’utilisons. Nous sommes en contact avec l’<a href="https://notification.canada.ca/contact?utm_source=FR_CadetsBlog2024&amp;utm_medium=Blog+Post&amp;utm_campaign=CDS_Blogs" target="_blank" rel="noreferrer noopener">équipe de soutien du produit</a> pour voir comment nous pourrons exploiter la fonction de message texte à l’avenir, et nous gardons un œil sur les nouvelles fonctionnalités de Formulaires GC pour voir comment nous pouvons mieux utiliser conjointement ces deux outils.</p>
...
<p class="wp-block-paragraph">Nous cherchions un moyen d’exploiter la capacité de Formulaires&nbsp;GC à collecter des données de niveau Protégé&nbsp;B, car nous avons beaucoup de documents qui doivent nous être soumis à ce niveau de sécurité. Nous étions très enthousiastes à l’idée de trouver un projet qui fonctionnerait pour cela, mais nous devions être en mesure de concevoir le formulaire en utilisant la logique conditionnelle pour qu’il soit réussi et qu’il permette d’obtenir les informations dont nous avions besoin. Il y a quelque temps, j’ai vu sur la <a href="https://trello.com/b/MaWVk9V5/formulaires-gc-strategie-fr" target="_blank" rel="noreferrer noopener">feuille de route</a> que l’équipe travaillait à cette fonctionnalité et j’ai attendu son lancement.<br></p>



<details class="wp-block-cds-snc-accordion"><summary>Comment la logique conditionnelle a amélioré l’expérience relative aux formulaires&nbsp;:</summary>
<p class="wp-block-paragraph">La logique conditionnelle modifie ce que les personnes voient lorsqu’elles remplissent un formulaire, en fonction de leurs réponses précédentes. Ceci améliore leur expérience, surtout quand le formulaire est long ou complexe. La division des formulaires en ligne en plusieurs pages et l’application de règles de logique conditionnelle peuvent contribuer à faciliter et à accélérer le remplissage. Cela signifie qu’il est possible de ne poser certaines questions que lorsqu’elles sont pertinentes ou d’orienter les personnes vers des chemins différents. En conséquence, la qualité des données collectées s’améliore souvent aussi.</p>



<p class="wp-block-paragraph"><a href="https://articles.alpha.canada.ca/forms-formulaires/fr/configurer-formulaire-avec-logique/?utm_source=FR_CadetsBlog2024&amp;utm_medium=Blog+Post&amp;utm_campaign=forms_blogs#h-appliquer-une-logique-d-embranchement-a-un-formulaire" target="_blank" rel="noreferrer noopener"><strong>Apprenez-en plus sur la configuration d’un formulaire avec la logique conditionnelle</strong></a></p>
</details>
...
<p class="wp-block-paragraph">Le processus d’obtention des renseignements sur la santé était complexe jusqu’ici. Auparavant, les corps et les escadrons (c’est-à-dire le personnel qui travaille bénévolement et à temps partiel) recevaient une indication qu’un cadet ou une cadette avait besoin d’un questionnaire de santé détaillé d’après les réponses données lors de l’inscription en ligne. Il s’agissait ensuite d’imprimer le formulaire et de le faire remplir par les parents, puis de l’envoyer par courrier ou par télécopie à l’équipe de liaison médicale de l’unité régionale de soutien aux cadets (URSC). Il y avait donc un délai d’attente dû à l’acheminement par voie postale, et les cadets et cadettes ne pouvaient pas participer tant que cela n’était pas fait.&nbsp;</p>



<p class="wp-block-paragraph">La transmission des données en ligne permet à notre personnel médical d’obtenir instantanément les informations et de mettre à jour les dossiers des cadets et cadettes dans les meilleurs délais, afin qu’ils et elles puissent commencer à participer plus rapidement!</p>



<p class="wp-block-paragraph">2. <strong>Il faut moins de temps qu’auparavant pour remplir le formulaire, car grâce à la logique conditionnelle, nous ne demandons que les informations requises. Ainsi, certain·e·s utilisateur·rice·s peuvent sauter jusqu’à 50&nbsp;questions.</strong></p>



<p class="wp-block-paragraph">Par exemple, pour la section consacrée aux médicaments, les questions détaillées n’apparaissent que si vous indiquez que le cadet ou la cadette prend des médicaments, tandis que si vous répondez «&nbsp;non&nbsp;», cette section est sautée.&nbsp;</p>



<p class="wp-block-paragraph">3. <strong>Moins de paperasse qu’avant! L’utilisation de la logique conditionnelle dans Formulaires&nbsp;GC nous a permis de combiner trois&nbsp;formulaires de santé papier en un seul formulaire en ligne, ce qui a éliminé deux&nbsp;étapes et a permis à nos utilisateur·rice·s de gagner du temps tout au long du processus.</strong></p>



<p class="wp-block-paragraph">Dans le questionnaire de santé en ligne, les formulaires de consentement pour la sensibilité alimentaire et l’anaphylaxie sont désormais intégrés, de sorte qu’il n’y a qu’une seule soumission requise au lieu de trois pour ces données.</p>
...
<p class="wp-block-paragraph">Comme indiqué précédemment, mon équipe fournit des services numériques à nos cadets et cadettes ainsi qu’à notre personnel. Depuis le début de cet essai, j’ai présenté notre travail sur le questionnaire de santé détaillé à plusieurs reprises et à plusieurs collègues.&nbsp;</p>



<p class="wp-block-paragraph"><strong>Les réactions sont extrêmement positives et enthousiastes; le personnel médical dit que cela lui fera gagner beaucoup de temps et réduira beaucoup les obstacles, ce qui améliorera le processus pour toutes les parties concernées. Il en voit les avantages et souhaite la numérisation d’autres formulaires afin d’améliorer la prestation de services.</strong></p>



<details class="wp-block-cds-snc-accordion"><summary>Garder un œil sur la feuille de route pour les fonctionnalités à venir</summary>
<p class="wp-block-paragraph">Nous cherchons constamment à améliorer la prestation de nos services. Nous sommes déjà de grand·e·s admirateur·rice·s et utilisateur·rice·s de Formulaires&nbsp;GC, mais nous attendons avec impatience les nouvelles fonctionnalités sur la <a href="https://trello.com/b/MaWVk9V5/formulaires-gc-strategie-fr" target="_blank" rel="noreferrer noopener">feuille de route du produit</a>, ainsi que les améliorations des fonctionnalités actuelles que nous utilisons.&nbsp;</p>



<p class="wp-block-paragraph"><strong><strong>Comment les prochaines fonctionnalités peuvent nous aider&nbsp;:</strong></strong></p>



<p class="wp-block-paragraph"><strong>Nous avons hâte que la future fonctionnalité de pièce jointe soit lancée, car celle-ci nous permettra de gagner du temps et de réduire davantage la paperasse administrative liée à la santé.</strong></p>



<p class="wp-block-paragraph">Nous avons contacté l’équipe de Formulaires GC pour devenir testeur·se·s bêta de cette fonctionnalité et nous sommes très enthousiastes à l’idée de voir si cela peut être une solution à long terme pour nos besoins en matière de collecte de données de niveau Protégé B.</p>



<ul class="wp-block-list">
<li><strong>Le fait de disposer d’API à la fois pour Notification GC et pour Formulaires GC pourrait nous permettre d’utiliser ces deux outils à plus grande échelle.</strong><br>Nos formulaires de santé, comme mentionné ci-dessus, ne sont actuellement pas envoyés par l’intermédiaire de Notification GC. Toutefois, il est possible d’intégrer Notification&nbsp;GC grâce à son API existante. Une fois que l’API de Formulaires&nbsp;GC sera disponible, elle améliorera encore les capacités d’intégration en offrant de nouvelles possibilités d’interaction fluide entre les systèmes.</li>
</ul>
</details>
...
<p class="wp-block-paragraph">Voici quelques liens qui vous aideront à démarrer&nbsp;:</p>
