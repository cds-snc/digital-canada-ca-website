...
<p class="wp-block-paragraph">Cette étude a révélé d’intéressantes données dans le contexte d’images de l’IA et de l’usage de citations de l’IA.</p>
...
<p class="wp-block-paragraph">Image&nbsp;2&nbsp;: Image d’une page de sujet décorative</p>
...
<p class="wp-block-paragraph">Une personne a répondu à cette question, «&nbsp;il n’y a aucun moyen de savoir si l’image a été créée par l’IA, alors je croirais que l’image (sans citation) serait plus à jour.&nbsp;»</p>



<p class="wp-block-paragraph">Qu’est-ce que cela indique? Cela nous indique que 78&nbsp;% des personnes ne veulent pas que l’IA soit utilisée du tout. En effet, <strong>cela nous indique que les personnes étaient déjà sceptiques de la présence ou non de l’IA dans les images.&nbsp;</strong></p>
...
<p class="wp-block-paragraph">Lorsque l’on donne le choix entre différentes citations pour une même image (Générée par l’IA OpenAl (2023)&nbsp;; Source&nbsp;: DALL-E [lA] (2023)&nbsp;; Créée avec l’IA, ou égal), la majorité des participants et participantes (59&nbsp;% pour l’image 1 et 60&nbsp;% pour l’image 2) ont dit qu’ils et elles faisaient également confiance à toutes les options, ce qui indique qu’il y avait peu de préférence.&nbsp;</p>



<details class="wp-block-cds-snc-accordion"><summary>Échantillons de sondage (citations d’image)</summary>
<p class="wp-block-paragraph">Les participants devaient sélectionner l’option à laquelle ils faisaient le plus confiance à partir d’éléments suivants, et pouvaient également choisir une quatrième option qui indique une confiance égale. Voici les images montrées aux participants et participantes.</p>



<p class="wp-block-paragraph">1&nbsp;: Générée par l’IA OpenAI (2023)</p>
...
<p class="wp-block-paragraph">2&nbsp;: Source&nbsp;: DALL-E [IA] (2023)</p>
...
<p class="wp-block-paragraph">3&nbsp;: Créée avec l’IA</p>
...
<p class="wp-block-paragraph">Curieusement, les résultats pour les citations de l’IA avec des textes étaient nettement différents que ceux obtenus pour les images de l’IA. Nous avons montré aux personnes qui ont participé trois passages identiques, mais chacun était assorti d’une citation différente.</p>



<details class="wp-block-cds-snc-accordion"><summary>Échantillons de sondage (passages identiques assortis de citations de styles différents)</summary>
<p class="wp-block-paragraph">Nous avons montré trois passages identiques assortis de trois citations de styles différents. Voici un exemple d’une citation longue.</p>


<img loading="lazy" decoding="async" width="1024" height="501" src="https://articles.alpha.canada.ca/uploads/sites/25/2025/02/unnamed-4-1024x501.png" alt="" class="wp-image-2622" style="max-width: 100%;height: auto;" srcset="https://articles.alpha.canada.ca/uploads/sites/25/2025/02/unnamed-4-1024x501.png 1024w, https://articles.alpha.canada.ca/uploads/sites/25/2025/02/unnamed-4-300x147.png 300w, https://articles.alpha.canada.ca/uploads/sites/25/2025/02/unnamed-4-768x376.png 768w, https://articles.alpha.canada.ca/uploads/sites/25/2025/02/unnamed-4-1536x751.png 1536w, https://articles.alpha.canada.ca/uploads/sites/25/2025/02/unnamed-4.png 1550w" sizes="auto, (max-width: 1024px) 100vw, 1024px" />


<p class="wp-block-paragraph">Légende&nbsp;: Un exemple de passage qui indique «&nbsp;Le ministre de la Sécurité publique et de la Protection civile peut décider de ne pas délivrer un passeport lorsqu&rsquo;il existe des motifs raisonnables de croire que cette décision est nécessaire pour empêcher la commission d&rsquo;une infraction terroriste ou pour assurer la sécurité nationale du Canada ou d&rsquo;un pays ou état étranger&nbsp;» avec une citation longue qui indique «&nbsp;Ce résumé du Décret sur les passeports canadiens a été généré par l’intelligence artificielle. Il a été passé en revue et modifié par des experts afin de veiller à son exactitude. La requête utilisée était la suivante&nbsp;: «&nbsp;Générer un résumé clair et professionnel de ce contenu&nbsp;», ChatGPT, OpenAI, 15&nbsp;mai&nbsp;2024.&nbsp;»</p>
</details>



<p class="wp-block-paragraph">Ensuite, nous avons demandé aux participants et participantes de répondre à une question distincte qui fournissait un passage sans citation et le même texte assorti d’une citation du type qu’ils ou elles avaient sélectionné à la dernière question. Quand on leur a demandé à quel passage ils ou elles faisaient le plus confiance, 68&nbsp;% ont dit qu’ils ou elles faisaient davantage confiance au passage assorti de la citation IA.&nbsp;</p>
...
<p class="wp-block-paragraph">Texte de remplacement&nbsp;: Un diagramme à barre qui démontre que 47&nbsp;% des personnes qui ont participé ont sélectionné l’outil d’IA personnalisé Canada.ca, que 20&nbsp;% ont sélectionné la solution Google IA, que 10&nbsp;% ont sélectionné la solution Bing Copilot, et que 23&nbsp;% ont dit qu’ils et elles éprouvaient le même degré de confiance envers toutes ces solutions.</p>



<details class="wp-block-details is-layout-flow wp-block-details-is-layout-flow"><summary>&nbsp;Échantillons de sondage (solutions d’IA personnalisées)</summary>
<p class="wp-block-paragraph">Image&nbsp;1&nbsp;: Fonction de clavardage IA de Bing</p>
...
<p class="wp-block-paragraph">Image&nbsp;3&nbsp;: Maquette de robot conversationnel IA personnalisé pour Canada.ca</p>
