...
<p class="wp-block-paragraph">Pour en savoir plus, nous avons discuté avec <a href="https://www.linkedin.com/in/breanna-fife-41b18964/" target="_blank" rel="noreferrer noopener">Breanna Fife</a>, gestionnaire principale de produit pour Connexion GC au sein de l’équipe des produits d’entreprise.</p>
...
<p class="wp-block-paragraph"><strong>La protection de la confidentialité des utilisateurs et utilisatrices</strong> est l’un des principes clés du service. Connexion GC permet aux utilisateurs et utilisatrices de suivre le processus de transmission des données, ce qui offre transparence et contrôle à chaque étape. Pour veiller à bien informer les utilisateurs et utilisatrices, nous offrons au bon moment des renseignements <strong>expliquant quelles données sont recueillies et comment ces données seront utilisées.</strong> Ainsi, les gens savent comment leurs renseignements sont utilisés et peuvent prendre des décisions éclairées concernant leur vie privée.</p>
...
<p class="wp-block-paragraph">L’équipe Connexion GC intègre les utilisateurs et utilisatrices à la conception dès le départ. Nous cherchons à créer une expérience de connexion intuitive, sécurisée et accessible pour tous et toutes.<br></p>
...
<p class="wp-block-paragraph"><strong>Une porte d’entrée unique :</strong> Plus besoin de créer de nouveaux identifiants. Avec Connexion GC, les utilisateurs et utilisatrices peuvent accéder aux services gouvernementaux à l’aide des options de connexion dont ils et elles disposent déjà.</p>



<p class="wp-block-paragraph"><strong>Des options de connexion flexibles : </strong>Connexion GC offre aux gens la possibilité d’utiliser les outils avec lesquels ils se sentent le plus à l’aise et qui correspondent le mieux à leurs besoins, qu’il s’agisse de clés d’accès, de données biométriques ou encore de méthodes traditionnelles. Après la connexion, il est très facile de gérer les identifiants et les informations.</p>
...
<p class="wp-block-paragraph"><strong>Une conception axée sur la confidentialité&nbsp;:</strong> Connexion&nbsp;GC indiquera clairement la manière dont les données collectées sont transmises et utilisées dans nos systèmes.&nbsp;</p>
</details>
