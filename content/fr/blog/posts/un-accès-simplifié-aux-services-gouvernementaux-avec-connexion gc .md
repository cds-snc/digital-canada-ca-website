...
tags: ["Conception de service","GC Connexion","Gestion de produits"]
...
<p><strong>Une porte d’entrée unique :</strong> Plus besoin de créer de nouveaux identifiants. Avec Connexion GC, les utilisateurs et utilisatrices peuvent accéder aux services gouvernementaux à l’aide des options de connexion dont ils et elles disposent déjà.</p>



<p><strong>Des options de connexion flexibles : </strong>Connexion GC offre aux gens la possibilité d’utiliser les outils avec lesquels ils se sentent le plus à l’aise et qui correspondent le mieux à leurs besoins, qu’il s’agisse de clés d’accès, de données biométriques ou encore de méthodes traditionnelles. Après la connexion, il est très facile de gérer les identifiants et les informations.</p>
...
<p><strong>Une conception axée sur la confidentialité&nbsp;:</strong> Connexion&nbsp;GC indiquera clairement la manière dont les données collectées sont transmises et utilisées dans nos systèmes.&nbsp;</p>
</details>
