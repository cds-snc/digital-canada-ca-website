...
<p class="wp-block-paragraph">Nos équipes Scrum sont composées de personnes possédant un large éventail de compétences et d’expertise (gestion du changement, gestion de produit, TI, recherche sur les utilisateurs, conception de l’expérience utilisateur, assistance à la clientèle, etc.) C’est également le cas dans l’équipe de transformation numérique de la DGSSM&nbsp;: des gestionnaires de changement à&nbsp; temps plein et des responsables de produit sont intégré·e·s aux équipes Scrum pour soutenir la numérisation des opérations et des services.</p>
...
<p class="wp-block-paragraph"><strong>Michael Peter Barker (responsable de produit&nbsp;— services aux gens de mer)</strong> met son expertise au service de l’unité de certification des gens de mer et guide l’équipe dans le développement de produits. Michael puise dans son expérience dans l’ingénierie maritime et dans la navigation pour aider l’unité à tracer une nouvelle voie vers le changement à TC.</p>



<p class="wp-block-paragraph"><strong>Katsiaryna Haisionak (chercheuse sur l’expérience utilisateur – services aux gens de mer)</strong> est conseillère et étudie les comportements, besoins et motivations des utilisateur·rice·s pour rendre les produits plus intuitifs et faciles à utiliser. Katsiaryna compte de nombreuses années d’expérience en recherche sur les utilisateurs et en conception de service dans les secteurs public et privé ainsi qu’en conception de produit.</p>



<p class="wp-block-paragraph"><strong>Cody Giroux (responsable de produit&nbsp;— certification d’assurance marine) </strong>fait partie de l’équipe de transformation de la DGSSM. Son expérience comprend des collaborations avec des équipes Scrum ainsi qu’avec des concepteur·rice·s d’expérience utilisateur, dans le privé comme dans le public. Cody a développé et mis en œuvre une vision précise pour différents types de services et de programmes, y compris des produits et services visant à soutenir les équipes de direction, les entreprises et le public.</p>



<p class="wp-block-paragraph"><strong>Daniel Bou-Mitry (coordonnateur du service à la clientèle — unité médicale maritime) </strong>joue le rôle de personne-contact pour les médecins examinateur·rice·s de la marine désigné·e·s.</p>
...
<p class="wp-block-paragraph">Nous utilisons Notification GC de différentes manières. L’équipe de certification d’assurance maritime l’utilise pour envoyer de la documentation aux propriétaires de navires qui achètent un certificat d’assurance maritime. Il s’agit alors d’envoyer jusqu’à soixante pièces jointes pour un seul courriel. Notification GC a grandement simplifié cette étape du processus. Nous utilisons également les renseignements sur le statut des envois pour nous assurer que les messages sont parvenus à leurs destinataires sans accrocs.</p>



<p class="wp-block-paragraph">Avant d’utiliser Notification&nbsp;GC, notre équipe devait joindre les documents (jusqu’à soixante éléments) un à un pour chaque courriel. Toutes ces étapes ont pu être automatisées grâce à l’API de Notification&nbsp;GC, et nous consacrons le temps ainsi gagné à d’autres tâches plus cruciales sur le plan opérationnel. De ce fait, nos processus sont maintenant beaucoup plus efficaces. Lorsqu’une demande de service est clôturée, nous pouvons immédiatement contacter notre clientèle par courriel à l’aide de Notification&nbsp;GC.</p>



<p class="wp-block-paragraph">Auparavant, le processus de réception des renseignements envoyés par les médecins examinateur·rice·s n’était pas simple. Aujourd’hui, nous y avons remédié grâce à Notification&nbsp;GC&nbsp;: en plus d’être utile à nos clients, cet outil minimise le nombre de courriels demandant un accusé de réception.</p>
...
<p class="wp-block-paragraph">Nous avons également trouvé une grande utilité à la <a href="https://notification.canada.ca/guide-mise-en-forme" target="_blank" rel="noreferrer noopener">fonctionnalité de gabarits</a>. Très facile d’utilisation, elle permet de changer rapidement le texte des modèles. Même si le texte d’un gabarit reste le même pendant des mois, nous n’avons aucune difficulté à nous connecter et à le modifier le moment venu.</p>
...
<p class="wp-block-paragraph">La Direction a également choisi cet outil en raison de sa simplicité d’installation et d’utilisation. Nous avons pu le configurer en moins d’un jour, et même lorsqu’il s’écoule beaucoup de temps entre deux utilisations, nous pouvons modifier les gabarits et faire des modifications de manière rapide et efficace. La simplicité est un atout de taille, surtout lorsque l’on peut se passer de l’aide de spécialistes en développement pour utiliser le produit. À cela vient s’ajouter la gratuité de l’outil. Cet élément signifiait que notre budget et nos ressources ne seraient pas affectés.</p>
